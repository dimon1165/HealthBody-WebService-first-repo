...
public interface IBaseService<TBaseDTO> {
	...
	void insert(TBaseDTO baseDTO) throws SQLException, JDBCDriverException, DataBaseReadingException,
	...
	void update(TBaseDTO baseDTO) throws SQLException, JDBCDriverException, DataBaseReadingException,
			QueryNotFoundException, EmptyResultSetException, TransactionException, CloseStatementException;

	// use just for test
	void test_delete(TBaseDTO baseDTO) throws SQLException, JDBCDriverException, QueryNotFoundException,
