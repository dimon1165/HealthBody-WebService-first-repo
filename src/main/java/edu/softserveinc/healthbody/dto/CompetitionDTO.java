...
public class CompetitionDTO {
	...
	public CompetitionDTO(final String name, final String count, final String startDate,
			final String finishDate, final String description,
			final String nameCriteria, final List<String> groups, final List<String> logins) {
		this.name = name;
		this.count = count;
